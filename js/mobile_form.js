...
function MobileForm() {
  ...
  MobileSwitcher.textContent = "Mobile Form";
  ...
  MobileLegend.textContent = "Please, enter your Mobile Nomber.";
  ...
  MobileNomberLabel.textContent = "Mobile Nomber";
  ...
  MobileButton.textContent = "Send code";
